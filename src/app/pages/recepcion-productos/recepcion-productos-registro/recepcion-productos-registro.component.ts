...
@Component({
    selector: 'app-recepcion-productos-registro',
    templateUrl: './recepcion-productos-registro.component.html',
    styleUrls: ['./recepcion-productos-registro.component.scss']
})
export class RecepcionProductosRegistroComponent implements OnInit {
    registro: RecepcionProductoModel = undefined;
    ...
    ngOnInit() {
        ...
        this.activatedRoute.paramMap.pipe(map(() => window.history.state)).subscribe((data) => {
            ...
            this.loading = false;
            this.router.navigate(['process/reception']);
          }
        })
    }
